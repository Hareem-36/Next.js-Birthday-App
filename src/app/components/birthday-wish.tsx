...
export default function BirthdayWish() {
  ...
  return (
    // Main container
    <div className="min-h-screen bg-gray flex items-center justify-center p-3">
      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center relative bg-cover bg-no-repeat" style={{ backgroundImage: "url('/path-to-your-image.jpg')" }}>
            <CardTitle className="text-4xl font-bold text-black">Happy 12th Birthday My Son !</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Syed Abdullah Shah</CardDescription>
            <p className="text-lg text-gray-500">May 18th</p>
            {/* New name div */}
       ...
       <div className="mt-6 text-purple-900 text-3xl font-bold underline">
